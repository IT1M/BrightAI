    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media (min-width: 480px) {
            .header-info h1 { font-size: var(--font-size-2xl); }
            .step-header h2 { font-size: var(--font-size-2xl); }
            .btn { width: auto; margin: 0; }
            .form-actions { flex-direction: row; }
            .header-actions { flex-direction: row; }
            .ai-assistant { max-width: 320px; left: var(--spacing-4); right: auto; }
        }
        
        @media (min-width: 768px) {
            .page-header { padding: var(--spacing-6) 0; }
            .header-content { 
                flex-direction: row; 
                text-align: left; 
                justify-content: space-between;
            ...
            .step-header h2 { font-size: var(--font-size-2xl); }
            .step-circle { width: 50px; height: 50px; font-size: var(--font-size-lg); }
            .step-title { font-size: var(--font-size-sm); max-width: 100px; }
            .progress-bar::before { top: 25px; }
            .detail-card h3 { font-size: var(--font-size-lg); }
            .detail-card li { font-size: var(--font-size-base); }
        }
    </style>
</head>
<body>
        ...
        <header class="page-header">
            <div class="header-content">
                <div class="header-info">
                    <img src="https://www2.0zz0.com/2025/07/12/12/475874739.png" alt="شعار شركة نمو" class="company-logo">
                    <h1><i class="fas fa-briefcase"></i> بوابة التوظيف الذكية MAISco. </h1>
                    <p>تجربة توظيف مخصصة مدعومة بالذكاء الاصطناعي </p>
                </div>
...
const App = function() {
    ...
    // --- CONFIG ---
    this.config = {
        groqApiKey: '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',
    ...
    this.displayFinalReport = (data) => { 
        ...
        const reportHTML = ` 
        <div id="pdf-report"> 
            <div style="text-align: center; margin-bottom: 1rem; border-bottom: 2px solid var(--primary); padding-bottom: 1rem;"> 
